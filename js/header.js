...
<nav class="navbar navbar-default" role="navigation">\
  <div class="container-fluid">\
    ...
    <div class="navbar-header">\
      ...
      <a class="navbar-brand" href="index.html">Comcast</a>\
    </div>\
\
      ...
      <ul class="nav navbar-nav">\
        ...
        <li class="dropdown">\
          ...
          <ul class="dropdown-menu">\
            ...
            <li class="divider"></li>\
            <li class="dropdown-header">Poor Consumption Model</li>\
            <li><a href="fishbone3.html">Dissatisfaction with Model</a></li>\
          </ul>\
        </li>\
        <li class="dropdown">\
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Other Frameworks <b class="caret"></b></a>\
          <ul class="dropdown-menu">\
            <li><a href="mental-models.html">Mental Models</a></li>\
            <li class="divider"></li>\
            <li><a href="scorecard.html">Balanced Scorecard</a></li>\
            <li class="divider"></li>\
            <li><a href="curr-future-state.html">Current Future State</a></li>\
            <li class="divider"></li>\
            <li class="dropdown-header">System Maps</li>\
...
<nav class="navbar navbar-default navbar-fixed-bottom" role="navigation">\
  <div class="container">\
    <p>By Fritz-Patrick Atienza, Claire Loncarich, Tilan Karunanayake, Sean Raley, Jaclyn Tseng, and Farah Zaidi</p>\
            ...
            // <li class="divider"></li>\
            // <li class="dropdown-header">Consumption Model Tradeoffs</li>\
            // <li><a href="current-tradeoffs.html">Current Tradeoffs</a></li>\
            // <li><a href="future-tradeoffs.html">Improved Tradeoffs</a></li>\